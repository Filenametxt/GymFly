    ...
    <nav class="navbar" role="navigation" aria-label="main navigation">
        <div class="container">
            <div class="navbar-brand">
                <a class="navbar-item" href="home" style="display: flex; align-items: center; gap: 6px;">
            ...
            <div class="navbar-end">
                <a class="navbar-item is-tab px-4 mr-2" href="registrazione">
                    <span>SIGN IN</span>
                    <span class="icon is-small ml-2">
                        <i class="fas fa-user-plus"></i>
                    </span>
                </a>
                <a class="navbar-item is-tab is-active-login px-4" href="login">
                    <span>LOG IN</span>
                    <span class="icon is-small ml-2">
